<div class="container my-4">
  <div class="card p-3 shadow-lg mb-3" style="background-color:#2e7d32; color:white; border-radius:1rem;">
      ...
      <div class="col-12 col-md-6">
        <div class="p-3 bg-dark bg-opacity-25 rounded">
          <div class="d-flex justify-content-between">
              <h5 class="fw-bold">⚫ Yang Yun Fan <img src="https://flagcdn.com/24x18/tw.png" alt="Taiwan"></h5>
    ...
    <div>
    <img src="Turno09.jpg" alt="Foto della partita" class="img-fluid rounded" />
...
<board data-type="show" data-label="commento" data-file="09-yang-signorini.json"
