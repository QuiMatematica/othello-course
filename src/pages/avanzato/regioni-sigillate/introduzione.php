...
regione. Riprendo qui la medesima definizione.</p>
...
le regioni in cui uno dei due colori non ha mosse legali.</p>

<div class="card border-primary mb-3">
	<div class="card-header">Definizione</div>
	<div class="card-body">
		<p class="card-text">Chiamiamo <b>regione sigillata</b> (in inglese <i>sealed region</i>) una regione
            in cui uno dei due colori non ha mosse legali.</p>
	</div>
</div>

<h2>Regioni sigillate dispari</h2>
...
<p>Concludono questo capitolo un paio di esempi di regioni formate da un'unica casella,
